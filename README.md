...
#### Enter the following into the URL bar:[url](https://github.com/suzukifn321-commits/pulite/blob/main/web/data%3Atext.txt)
...
#### URL 欄に次を入力してください：[url](https://github.com/suzukifn321-commits/pulite/blob/main/web/data%3Atext.txt)
##### この方法は非推奨です。

##### このプロジェクトは [TurboWarp](https://turbowarp.org/) を使用して作成されました。
